...
class TMMPageKeyDataSource(private val movieApi: MovieApi, private val region: String) : PageKeyedDataSource<Int, Movie>() {
    override fun loadInitial(params: LoadInitialParams<Int>, callback: LoadInitialCallback<Int, Movie>) {
        Log.d("TAG", "loadInitial: ${params.requestedLoadSize}")
        movieApi.getThisMonthMovie(region, 1)
    ...
    override fun loadAfter(params: LoadParams<Int>, callback: LoadCallback<Int, Movie>) {
        ...
        movieApi.getThisMonthMovie(region, params.key)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(
                        {
