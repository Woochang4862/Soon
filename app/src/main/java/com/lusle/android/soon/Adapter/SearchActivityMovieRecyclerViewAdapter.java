...
public class SearchActivityMovieRecyclerViewAdapter extends BaseRecyclerAdapter<RecyclerView.ViewHolder> {
    ...
    public SearchActivityMovieRecyclerViewAdapter(RecyclerView recyclerView) {
        super(recyclerView);
        list = new ArrayList<>();
        genres = new HashMap<>();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_PROG) {
            ...
            vh = new SearchMovieViewHolder(v);
        }
        return vh;
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof SearchMovieViewHolder) {
