...
public class ReleaseAlarmPresenter implements ReleaseAlarmContact.Presenter {

    private ReleaseAlarmContact.View view;
    ...
    @Override
    public void attachView(ReleaseAlarmContact.View view) {
        this.view = view;
    }
    ...
    public void setOnItemClickListener() {
        adapterModel.setOnAlarmItemClickListener((v, pos) -> {
