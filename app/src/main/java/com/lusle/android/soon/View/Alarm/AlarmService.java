...
public class AlarmService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Pair<Integer, Notification> p;
        if (intent != null)
            p = startForegroundService();
        else {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                p = new Pair<>(404, new Notification.Builder(this, CHANNEL_ID).build());
            } else {
                p = new Pair<>(404, new Notification.Builder(this).build());
            }
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    private Pair<Integer, Notification> startForegroundService() {
        ...
        if (data != null && data.isActive()) {
            ...
            Intent __intent = new Intent(this, AlarmReceiver.class);
            ...
            alarms.remove(data);
            Log.d("####", "startForegroundService: " + alarms + " " + data);
