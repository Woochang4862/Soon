...
import com.lusle.soon.Adapter.PreviewImageAdapter;
import com.lusle.soon.Adapter.VideoThumbnailAdapter;
import com.lusle.soon.Model.Backdrop;
import com.lusle.soon.Model.Genre;
import com.lusle.soon.Model.MovieDetail;
import com.lusle.soon.Model.Poster;
import com.lusle.soon.SubtitleCollapsingToolbarLayout.SubtitleCollapsingToolbarLayout;
...
public class DetailActivity extends BaseActivity {
    ...
    private TextView voteCount, voteAverageLabel, genre, releaseDate, runtime, popularity, overview, revenue, budget, originalLang, originalTitle, videoEmptyView, previewEmptyView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoThumbnailAdapter.setOnEmptyListener(new BaseRecyclerAdapter.OnEmptyListener() {
            @Override
            public void onEmpty() {
        ...
        previewImageAdapter.setOnEmptyListener(new BaseRecyclerAdapter.OnEmptyListener() {
            @Override
            public void onEmpty() {
        ...
        APIClient.getClient().create(APIInterface.class).getMovieDetails(id).enqueue(new retrofit2.Callback<MovieDetail>() {
            @Override
            public void onResponse(Call<MovieDetail> call, Response<MovieDetail> response) {
                ...
                revenue.setText((data.getRevenue() == 0) ? "-" : "$" + data.getRevenue());
                budget.setText((data.getBudget() == 0) ? "-" : "$" + data.getBudget());
