...
import com.lusle.soon.Adapter.AllSearchActivityCompanyRecyclerViewAdapter;
import com.lusle.soon.Adapter.AllSearchActivityMovieRecyclerViewAdapter;
...
public class AllSearchFragment extends Fragment implements SearchActivity.OnQueryReceivedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        companyAdapter.setOnEmptyListener(new BaseRecyclerAdapter.OnEmptyListener() {
            @Override
            public void onEmpty() {
        ...
        movieAdapter.setOnEmptyListener(new BaseRecyclerAdapter.OnEmptyListener() {
            @Override
            public void onEmpty() {
